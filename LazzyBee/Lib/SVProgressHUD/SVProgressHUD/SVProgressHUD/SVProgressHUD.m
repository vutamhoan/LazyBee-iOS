...
@synthesize overlayWindow, hudView, maskType, showNetworkIndicator, fadeOutTimer, stringLabel, imageView, spinnerView, visibleKeyboardHeight, dismissCompleteBlock;
...
+ (SVProgressHUD*)sharedViewOnTopOfViewController:(UIViewController *)viewController {
	if(sharedView == nil) {
        if (viewController != nil) {
            sharedView = [[SVProgressHUD alloc] initWithFrame:[viewController.view bounds]];
        } else {
...
+ (void)setStatus:(NSString *)string {
	[[SVProgressHUD sharedViewOnTopOfViewController:nil] setStatus:string];
}

#pragma mark - Show Methods

+ (void)showOnTopOfViewController:(UIViewController *)viewController {
    [[SVProgressHUD sharedViewOnTopOfViewController:viewController] showWithStatus:nil maskType:SVProgressHUDMaskTypeNone networkIndicator:NO];
}

+ (void)showOnTopOfViewController:(UIViewController *)viewController withStatus:(NSString *)status {
    [[SVProgressHUD sharedViewOnTopOfViewController:viewController] showWithStatus:status maskType:SVProgressHUDMaskTypeNone networkIndicator:NO];
}

+ (void)showOnTopOfViewController:(UIViewController *)viewController withMaskType:(SVProgressHUDMaskType)maskType {
    [[SVProgressHUD sharedViewOnTopOfViewController:viewController] showWithStatus:nil maskType:maskType networkIndicator:NO];
}
...
+ (void)showOnTopOfViewController:(UIViewController *)viewController withStatus:(NSString*)status maskType:(SVProgressHUDMaskType)maskType {
    [[SVProgressHUD sharedViewOnTopOfViewController:viewController] showWithStatus:status maskType:maskType networkIndicator:NO];
}

+ (void)showOnTopOfViewController:(UIViewController *)viewController withStatus:(NSString *)status networkIndicator:(BOOL)show {
    [[SVProgressHUD sharedViewOnTopOfViewController:viewController] showWithStatus:status maskType:SVProgressHUDMaskTypeNone networkIndicator:show];
}
...
+ (void)showOnTopOfViewController:(UIViewController *)viewController withMaskType:(SVProgressHUDMaskType)maskType networkIndicator:(BOOL)show {
    [[SVProgressHUD sharedViewOnTopOfViewController:viewController] showWithStatus:nil maskType:maskType networkIndicator:show];
}
...
+ (void)showOnTopOfViewController:(UIViewController *)viewController withStatus:(NSString*)status maskType:(SVProgressHUDMaskType)maskType networkIndicator:(BOOL)show {
    [[SVProgressHUD sharedViewOnTopOfViewController:viewController] showWithStatus:status maskType:maskType networkIndicator:show];
}
...
+ (void)showSuccessWithStatus:(NSString *)string duration:(NSTimeInterval)duration {
    [SVProgressHUD showOnTopOfViewController:nil];
...
+ (void)dismiss {
    [[SVProgressHUD sharedViewOnTopOfViewController:nil] dismiss];
}

+ (void)dismiss:(void (^)(void))successBlock {
    [[SVProgressHUD sharedViewOnTopOfViewController:nil] dismiss:successBlock];
}

+ (void)dismissWithSuccess:(NSString*)successString {
    [[SVProgressHUD sharedViewOnTopOfViewController:nil] dismissWithStatus:successString error:NO];
}

+ (void)dismissWithSuccess:(NSString *)successString afterDelay:(NSTimeInterval)seconds {
    [[SVProgressHUD sharedViewOnTopOfViewController:nil] dismissWithStatus:successString error:NO afterDelay:seconds];
}

+ (void)dismissWithError:(NSString*)errorString {
	[[SVProgressHUD sharedViewOnTopOfViewController:nil] dismissWithStatus:errorString error:YES];
}

+ (void)dismissWithError:(NSString *)errorString afterDelay:(NSTimeInterval)seconds {
    [[SVProgressHUD sharedViewOnTopOfViewController:nil] dismissWithStatus:errorString error:YES afterDelay:seconds];
}
